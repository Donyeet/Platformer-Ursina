...
window.cog_menu.enabled = True
window.title = 'Urono'
window.icon = 'duh.png'

Sky()
player_model = "sphere"
player = FirstPersonController(model=player_model, scale=2, texture='white_cube',
                               color=color.orange, coliider='sphere', position=(0, 20, 0), shader=lit_with_shadows_shader)
...
Platform(Vec3(275.485, 50.3791, -206.344))
Platform(Vec3(275.486, 52.046, -206.386))
